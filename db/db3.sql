...
CREATE TABLE "filingcost" (
  "documents" INTEGER NOT NULL,
  "filing_fees" INTEGER NOT NULL,
  "unit" TEXT NOT NULL,
  "qty" INTEGER,
  ...
  CONSTRAINT "pk_filingcost" PRIMARY KEY ("documents", "filing_fees")
);

CREATE INDEX "idx_filingcost__filing_fees" ON "filingcost" ("filing_fees");

ALTER TABLE "filingcost" ADD CONSTRAINT "fk_filingcost__documents" FOREIGN KEY ("documents") REFERENCES "document" ("id");

ALTER TABLE "filingcost" ADD CONSTRAINT "fk_filingcost__filing_fees" FOREIGN KEY ("filing_fees") REFERENCES "filingfee" ("id");
...
CREATE TABLE "healthevent" (
  ...
  "startdate" TIMESTAMP,
  "enddate" TIMESTAMP,
  "reporting_prison_officer" INTEGER NOT NULL
);
