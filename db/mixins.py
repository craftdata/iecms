...
ref_columns = ['name', 'description', 'notes']
...
case_activity = [
	...
	('Tracking', {'fields': ['not_started', 'delayed_start', 'actual_start', 'actual_end', 'delayed_end', 'completed'],
	              'expanded': False}),
...
activity_fieldset = [
	...
	('Details', {'fields': ['task_group', 'segment','priority'], 'expanded': False}),
	('Tracking', {'fields': ['not_started','delayed_start','actual_start', 'actual_end','delayed_end','completed'], 'expanded': False}),
	('Contingency', {'fields': ['contingency_plan'], 'expanded': False}),
	]
...
place_fieldset = [
	('Where', {'fields': ['place_name', 'nearest_feature', 'lat', 'lng', 'alt']}),
	('Map', {'fields': ['map', 'pin', 'pin_color', 'centered']})
	]
...
person_fieldset = [
	...
	('Identity', {'fields': ['firstname', 'surname', 'othernames', 'gender', 'dob', 'marital_status'], 'expanded': True})
	]

person_show_fieldset = [
	('Picture', {'fields': ['photo_img','photo']}),
	('Identity', {'fields': ['firstname', 'surname', 'othernames', 'gender', 'age', 'dob', 'marital_status'], 'expanded': True})
	]
...
employment_fieldset = [
	('Employment', {'fields': ['employed', 'employer', 'employer_contact']}),
	('Employment Dates',
	 {'fields': ['employ_role', 'employment_date', 'termination_date', 'supervisor', 'supervisor_contact']}),
	]
...
casey_fieldset = [
	('Initiation',
	    {'fields' : ['policestation','ob_number','report_date','report_notes'], 'expanded': False}),
	('Evaluation',
	    {'fields': ['natureofsuit','policeman','initial_report','plaintiff','defendant','observer','priority','evaluation_conclusion','should_investigate_further']}),
	('Investigation',
	    {'fields': ['investigation_assigment_date','policeman1','investigation_assignment_note','investigation_plan','investigation_summary']}),
	('AG Advice',
	    {'fields':['ag_advice_requested','ag_advice_req_date','ag_advice','ag_advice_date','send_to_trial','charge_date']}),
	('Prosecution',
	    {'fields':['take_to_trial','causeofaction','docketnumber', 'case_name','prosecutor','prosecution_notes','defense_notes','judgement_date','judgement','case_closed','closed_date']}),
	('Sentencing',
	    {'fields':['fine_amount','sentence_length','sentence_startdate','sentenceexpirydate','case_appealed','appeal_date','appeal_granted']})
	]
...
doc_edit_fieldset = [
('Data',
	 {'fields': ['doctitle','doc', 'doc_text'], 'expanded': True}),
('Context',
...
doc_show_fieldset = [
('Data',
	 {'fields': ['doctitle','doc_img', 'doc_text','play_audio'], 'expanded': True}),
('Context',
	 {'fields': ['subject', 'author', 'keywords','comments'], 'expanded': False}),
...
audio_show_fieldset = [
('Data',
	 {'fields': ['doctitle','play_audio', 'doc_text'], 'expanded': True}),
('Context',
	 {'fields': ['subject', 'author', 'keywords','comments'], 'expanded': False}),
