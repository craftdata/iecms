...
CREATE TABLE "schedulestatus" (
  "id" SERIAL CONSTRAINT "pk_schedulestatus" PRIMARY KEY
);
...
ALTER TABLE "hearing" ADD CONSTRAINT "fk_hearing__schedule_status" FOREIGN KEY ("schedule_status") REFERENCES "schedulestatus" ("id");
...
CREATE TABLE "courtcase_hearings" (
  "courtcase" INTEGER NOT NULL,
  "hearing" INTEGER NOT NULL,
  CONSTRAINT "pk_courtcase_hearings" PRIMARY KEY ("courtcase", "hearing")
);

CREATE INDEX "idx_courtcase_hearings" ON "courtcase_hearings" ("hearing");

ALTER TABLE "courtcase_hearings" ADD CONSTRAINT "fk_courtcase_hearings__courtcase" FOREIGN KEY ("courtcase") REFERENCES "courtcase" ("id");

ALTER TABLE "courtcase_hearings" ADD CONSTRAINT "fk_courtcase_hearings__hearing" FOREIGN KEY ("hearing") REFERENCES "hearing" ("id");
...
CREATE INDEX "idx_filing__court_case" ON "filing" ("court_case");

CREATE INDEX "idx_filing__filing_fee" ON "filing" ("filing_fee");

CREATE INDEX "idx_filing__issue" ON "filing" ("issue");

CREATE INDEX "idx_filing__judicial_officer" ON "filing" ("judicial_officer");

ALTER TABLE "filing" ADD CONSTRAINT "fk_filing__court_case" FOREIGN KEY ("court_case") REFERENCES "courtcase" ("id");

ALTER TABLE "filing" ADD CONSTRAINT "fk_filing__filing_fee" FOREIGN KEY ("filing_fee") REFERENCES "filingfee" ("id");

ALTER TABLE "filing" ADD CONSTRAINT "fk_filing__issue" FOREIGN KEY ("issue") REFERENCES "issue" ("id");

ALTER TABLE "filing" ADD CONSTRAINT "fk_filing__judicial_officer" FOREIGN KEY ("judicial_officer") REFERENCES "judicialofficer" ("id");
...
CREATE INDEX "idx_transcript__court_case" ON "transcript" ("court_case");

ALTER TABLE "transcript" ADD CONSTRAINT "fk_transcript__court_case" FOREIGN KEY ("court_case") REFERENCES "courtcase" ("id");
