...
CREATE TABLE "page" (
  "id" SERIAL CONSTRAINT "pk_page" PRIMARY KEY,
  "document" INTEGER NOT NULL,
  "page_image" BYTEA,
  "page_no" BIGINT,
...
ALTER TABLE "page" ADD CONSTRAINT "fk_page__document" FOREIGN KEY ("document") REFERENCES "document" ("id");
...
ALTER TABLE "bill" ADD CONSTRAINT "fk_bill__party_paying" FOREIGN KEY ("party_paying") REFERENCES "party" ("complaints");
...
ALTER TABLE "biodata" ADD CONSTRAINT "fk_biodata__party" FOREIGN KEY ("party") REFERENCES "party" ("complaints");
...
ALTER TABLE "notificationregister" ADD CONSTRAINT "fk_notificationregister__party" FOREIGN KEY ("party") REFERENCES "party" ("complaints");
