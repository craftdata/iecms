...
INSERT INTO country(code,name) VALUES ('AC','Ascension Island');
...
INSERT INTO country(code,name) VALUES ('CI','Cote D''Ivoire (Ivory Coast)');
...
INSERT INTO country(code,name) VALUES ('CS','Czechoslovakia (former)');
...
INSERT INTO country(code,name) VALUES ('GB','Great Britain (UK)');
...
INSERT INTO country(code,name) VALUES ('GS','S. Georgia and S. Sandwich Isls.');
...
INSERT INTO country(code,name) VALUES ('MK','F.Y.R.O.M. (Macedonia)');
...
INSERT INTO country(code,name) VALUES ('NZ','New Zealand (Aotearoa)');
...
INSERT INTO country(code,name) VALUES ('SJ','Svalbard & Jan Mayen Islands');
INSERT INTO country(code,name) VALUES ('SK','Slovak Republic');
...
INSERT INTO country(code,name) VALUES ('SU','USSR (former)');
...
INSERT INTO country(code,name) VALUES ('UM','US Minor Outlying Islands');
...
INSERT INTO country(code,name) VALUES ('VA','Vatican City State (Holy See)');
INSERT INTO country(code,name) VALUES ('VC','Saint Vincent & the Grenadines');
...
INSERT INTO country(code,name) VALUES ('YU','Yugoslavia (former)');
...
-- Populate the
INSERT INTO complaintrole (name, created_on, changed_on)
VALUES ('Complainant', current_timestamp, current_timestamp),
       ('Accused'),
       ('Character Reference'),
       ('Witness');

INSERT INTO complaintrole (name)
VALUES ('Complainant'),
       ('Accused'),
       ('Witness');

INSERT INTO experttype (name)
VALUES ('Technical'),
       ('Legal'),
       ('Pscychologist'),
       ('Doctor (GP)'),
...
INSERT INTO PoliceOfficerRank (name)
VALUES ('Constable'),
       ('Sergeant'),
       ('Senior Sergeant'),
       ('Inspector'),
...
INSERT INTO schedulestatustype (name)
VALUES ('Deferred'),
        ('Rescheduled'),
       ('Adjourned'),
       ('Completed'),
...
Insert into Casecategory(name)
VALUES ('Criminal'),
        ('Civil');

INSERT into Caselinktype(name)
VALUES ('Appeal'),
        ('Withdrawl'),
        ('Joinder');