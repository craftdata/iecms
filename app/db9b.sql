CREATE TABLE "accounttype" (
  "id" SERIAL CONSTRAINT "pk_accounttype" PRIMARY KEY
);
...
CREATE TABLE "casechecklist" (
  "id" SERIAL CONSTRAINT "pk_casechecklist" PRIMARY KEY,
  "check_list_item" VARCHAR(100) NOT NULL,
...
ALTER TABLE "casecategorychecklist" ADD CONSTRAINT "fk_casecategorychecklist__case_categories" FOREIGN KEY ("case_categories") REFERENCES "casecategory" ("id");

ALTER TABLE "casecategorychecklist" ADD CONSTRAINT "fk_casecategorychecklist__case_checklists" FOREIGN KEY ("case_checklists") REFERENCES "casechecklist" ("id");
...
CREATE TABLE "csiequipment" (
  "id" SERIAL CONSTRAINT "pk_csiequipment" PRIMARY KEY
);
...
CREATE INDEX "idx_experttype__expert_type" ON "experttype" ("expert_type");

ALTER TABLE "experttype" ADD CONSTRAINT "fk_experttype__expert_type" FOREIGN KEY ("expert_type") REFERENCES "experttype" ("id");
...
CREATE TABLE "feeclass" (
  "id" SERIAL CONSTRAINT "pk_feeclass" PRIMARY KEY,
  "fee_type" INTEGER
);

CREATE INDEX "idx_feeclass__fee_type" ON "feeclass" ("fee_type");

ALTER TABLE "feeclass" ADD CONSTRAINT "fk_feeclass__fee_type" FOREIGN KEY ("fee_type") REFERENCES "feeclass" ("id");
...
ALTER TABLE "feetype" ADD CONSTRAINT "fk_feetype__account_type" FOREIGN KEY ("account_type") REFERENCES "accounttype" ("id");

ALTER TABLE "feetype" ADD CONSTRAINT "fk_feetype__filing_fee_type" FOREIGN KEY ("filing_fee_type") REFERENCES "feeclass" ("id");
...
ALTER TABLE "hearingtype" ADD CONSTRAINT "fk_hearingtype__hearing_type" FOREIGN KEY ("hearing_type") REFERENCES "hearingtype" ("id");
...
CREATE TABLE "law" (
  "id" SERIAL CONSTRAINT "pk_law" PRIMARY KEY,
  "name" TEXT NOT NULL,
...
CREATE TABLE "crime" (
  ...
  "ref" TEXT NOT NULL,
  "ref_law" INTEGER,
  "min_sentence" TEXT NOT NULL,
  "max_sentence" TEXT NOT NULL,
  "max_fine" DECIMAL(12, 2)
);

CREATE INDEX "idx_crime__ref_law" ON "crime" ("ref_law");

ALTER TABLE "crime" ADD CONSTRAINT "fk_crime__ref_law" FOREIGN KEY ("ref_law") REFERENCES "law" ("id");
...
CREATE TABLE "legalreference" (
  ...
  "klr_url_full" VARCHAR(300) NOT NULL,
  "klr_rul_short" TEXT NOT NULL,
  "doc_id" VARCHAR(300) NOT NULL
);

CREATE TABLE "notificationtype" (
  "id" SERIAL CONSTRAINT "pk_notificationtype" PRIMARY KEY,
  "name" TEXT NOT NULL,
  "description" TEXT NOT NULL
);

CREATE TABLE "notifyevent" (
  "id" SERIAL CONSTRAINT "pk_notifyevent" PRIMARY KEY
);
...
CREATE TABLE "courtcase" (
  ...
  "docket_number" VARCHAR(200) NOT NULL,
...
CREATE TABLE "sysviewlist" (
  "id" SERIAL CONSTRAINT "pk_sysviewlist" PRIMARY KEY,
  "sys_name" VARCHAR(100) UNIQUE NOT NULL,
  "sys_route" VARCHAR(200) NOT NULL,
  "sys_perms" VARCHAR(300) NOT NULL,
  "sys_template" TEXT NOT NULL,
  "sys_title" VARCHAR(100) NOT NULL,
  "sys_wtf" BOOLEAN,
  "sys_table_name" VARCHAR(100) NOT NULL
);

CREATE TABLE "sysviewfld" (
  "id" SERIAL CONSTRAINT "pk_sysviewfld" PRIMARY KEY,
  "sys__view" INTEGER NOT NULL,
  "fld_name" VARCHAR(100) NOT NULL,
  "fld_type" VARCHAR(100) NOT NULL,
  "fld_unique" BOOLEAN,
  "fld_validator" VARCHAR(200) NOT NULL,
  "fld_choices" VARCHAR(300) NOT NULL DEFAULT '[(''cpp'', ''C++''), (''py'', ''Python''), (''text'', ''Plain Text'')]',
  "fld_label" VARCHAR(100) NOT NULL,
  "fld_default" VARCHAR(100) NOT NULL,
  "fld_widget" VARCHAR(200) NOT NULL
);

CREATE INDEX "idx_sysviewfld__sys__view" ON "sysviewfld" ("sys__view");

ALTER TABLE "sysviewfld" ADD CONSTRAINT "fk_sysviewfld__sys__view" FOREIGN KEY ("sys__view") REFERENCES "sysviewlist" ("id");

CREATE TABLE "syswkflowgrp" (
  "id" SERIAL CONSTRAINT "pk_syswkflowgrp" PRIMARY KEY,
  "sys_cat_name" VARCHAR(200) UNIQUE NOT NULL,
  "sys_cat_description" VARCHAR(200),
  "sys_cat_notes" TEXT NOT NULL
);

CREATE TABLE "sysuserextra" (
  "id" SERIAL CONSTRAINT "pk_sysuserextra" PRIMARY KEY,
  "sys_notes" TEXT NOT NULL,
  "sys_birthday" DATE,
  "sys_job_grade" TEXT NOT NULL,
  "sys_home_address" TEXT NOT NULL,
  "alt_phone" VARCHAR(20) NOT NULL,
  "alt_email" VARCHAR(120) NOT NULL,
  "office_address" TEXT NOT NULL,
  "off_email" VARCHAR(120) NOT NULL,
  "syswkflowgrp" INTEGER NOT NULL,
  "off_phone" VARCHAR(20) NOT NULL
);

CREATE INDEX "idx_sysuserextra__syswkflowgrp" ON "sysuserextra" ("syswkflowgrp");

ALTER TABLE "sysuserextra" ADD CONSTRAINT "fk_sysuserextra__syswkflowgrp" FOREIGN KEY ("syswkflowgrp") REFERENCES "syswkflowgrp" ("id");

CREATE TABLE "syswkflow" (
  "id" SERIAL CONSTRAINT "pk_syswkflow" PRIMARY KEY,
  "sys_name" VARCHAR(200) UNIQUE,
  "sys_description" VARCHAR(200),
  "sys_notes" TEXT,
  "syswkflowgrp" INTEGER,
  "sys_wkflow_template" TEXT NOT NULL,
  "sys_steps" INTEGER
);

CREATE INDEX "idx_syswkflow__syswkflowgrp" ON "syswkflow" ("syswkflowgrp");

ALTER TABLE "syswkflow" ADD CONSTRAINT "fk_syswkflow__syswkflowgrp" FOREIGN KEY ("syswkflowgrp") REFERENCES "syswkflowgrp" ("id");

CREATE TABLE "syswkflowviewseq" (
  "sys__view__lists" INTEGER NOT NULL,
  "sys_wkflows" INTEGER NOT NULL,
  "sys_order" BIGINT NOT NULL,
  "sys_is_terminal" BOOLEAN,
  CONSTRAINT "pk_syswkflowviewseq" PRIMARY KEY ("sys__view__lists", "sys_wkflows")
);

CREATE INDEX "idx_syswkflowviewseq__sys_wkflows" ON "syswkflowviewseq" ("sys_wkflows");

ALTER TABLE "syswkflowviewseq" ADD CONSTRAINT "fk_syswkflowviewseq__sys__view__lists" FOREIGN KEY ("sys__view__lists") REFERENCES "sysviewlist" ("id");

ALTER TABLE "syswkflowviewseq" ADD CONSTRAINT "fk_syswkflowviewseq__sys_wkflows" FOREIGN KEY ("sys_wkflows") REFERENCES "syswkflow" ("id");

CREATE TABLE "templatetype" (
  "id" SERIAL CONSTRAINT "pk_templatetype" PRIMARY KEY,
  "template_type" INTEGER
);

CREATE INDEX "idx_templatetype__template_type" ON "templatetype" ("template_type");

ALTER TABLE "templatetype" ADD CONSTRAINT "fk_templatetype__template_type" FOREIGN KEY ("template_type") REFERENCES "templatetype" ("id");
...
ALTER TABLE "doctemplate" ADD CONSTRAINT "fk_doctemplate__template_type" FOREIGN KEY ("template_type") REFERENCES "templatetype" ("id");
...
CREATE TABLE "document" (
  ...
  "file_hash" VARCHAR(520) NOT NULL,
  "file_create_date" TIMESTAMP,
  "file_update_date" TIMESTAMP,
  "file_last_opened_date" TIMESTAMP,
  ...
  "request_urgent" BOOLEAN,
  "certify_urgent" BOOLEAN,
  "certifying_judicial_officer" INTEGER,
  "certify_date" TIMESTAMP,
  "expiry_date" TIMESTAMP
);

CREATE INDEX "idx_document__certifying_judicial_officer" ON "document" ("certifying_judicial_officer");
...
CREATE INDEX "idx_document__receiving_registrar" ON "document" ("receiving_registrar");

CREATE INDEX "idx_document__review_registrar" ON "document" ("review_registrar");

ALTER TABLE "document" ADD CONSTRAINT "fk_document__certifying_judicial_officer" FOREIGN KEY ("certifying_judicial_officer") REFERENCES "judicialofficer" ("id");
...
ALTER TABLE "document" ADD CONSTRAINT "fk_document__receiving_registrar" FOREIGN KEY ("receiving_registrar") REFERENCES "judicialofficer" ("id");

ALTER TABLE "document" ADD CONSTRAINT "fk_document__review_registrar" FOREIGN KEY ("review_registrar") REFERENCES "judicialofficer" ("id");

CREATE TABLE "docpart" (
  "id" SERIAL CONSTRAINT "pk_docpart" PRIMARY KEY,
  ...
  "file_hash" VARCHAR(520) NOT NULL,
  "file_load_path" VARCHAR(300) NOT NULL,
  "file_upload_date" TIMESTAMP,
  "page_count" INTEGER,
  "file_text" TEXT NOT NULL,
  "is_image" BOOLEAN,
  "file_parse_status" TEXT NOT NULL,
  "file_assessed" BOOLEAN,
  "file_accepted" BOOLEAN,
  "file_fee_amount" DECIMAL(12, 2),
  "language" VARCHAR(10) NOT NULL DEFAULT 'English',
  "file_bin" TEXT NOT NULL
);

CREATE INDEX "idx_docpart__document" ON "docpart" ("document");

ALTER TABLE "docpart" ADD CONSTRAINT "fk_docpart__document" FOREIGN KEY ("document") REFERENCES "document" ("id");
...
ALTER TABLE "courtaccount" ADD CONSTRAINT "fk_courtaccount__account__types" FOREIGN KEY ("account__types") REFERENCES "accounttype" ("id");

ALTER TABLE "courtaccount" ADD CONSTRAINT "fk_courtaccount__courts" FOREIGN KEY ("courts") REFERENCES "court" ("id");
...
CREATE TABLE "complaint" (
  ...
  "magistrate_report_date" TIMESTAMP,
...
ALTER TABLE "complaint" ADD CONSTRAINT "fk_complaint__reported_to_judicial_officer" FOREIGN KEY ("reported_to_judicial_officer") REFERENCES "judicialofficer" ("id");
...
CREATE TABLE "party" (
  "id" INTEGER CONSTRAINT "pk_party" PRIMARY KEY,
...
ALTER TABLE "party" ADD CONSTRAINT "fk_party__relative" FOREIGN KEY ("relative") REFERENCES "party" ("id");

CREATE TABLE "bill" (
  "id" SERIAL CONSTRAINT "pk_bill" PRIMARY KEY,
  "assessing_registrar" INTEGER NOT NULL,
...
ALTER TABLE "bill" ADD CONSTRAINT "fk_bill__assessing_registrar" FOREIGN KEY ("assessing_registrar") REFERENCES "judicialofficer" ("id");

ALTER TABLE "bill" ADD CONSTRAINT "fk_bill__court" FOREIGN KEY ("court") REFERENCES "court" ("id");

ALTER TABLE "bill" ADD CONSTRAINT "fk_bill__court_account_courts__court_account_account__types" FOREIGN KEY ("court_account_courts", "court_account_account__types") REFERENCES "courtaccount" ("courts", "account__types");

ALTER TABLE "bill" ADD CONSTRAINT "fk_bill__documents" FOREIGN KEY ("documents") REFERENCES "document" ("id");

ALTER TABLE "bill" ADD CONSTRAINT "fk_bill__lawyer_paying" FOREIGN KEY ("lawyer_paying") REFERENCES "lawyer" ("id");

ALTER TABLE "bill" ADD CONSTRAINT "fk_bill__party_paying" FOREIGN KEY ("party_paying") REFERENCES "party" ("id");

ALTER TABLE "bill" ADD CONSTRAINT "fk_bill__receiving_registrar" FOREIGN KEY ("receiving_registrar") REFERENCES "judicialofficer" ("id");

CREATE TABLE "billdetail" (
  "id" SERIAL CONSTRAINT "pk_billdetail" PRIMARY KEY,
...
ALTER TABLE "billdetail" ADD CONSTRAINT "fk_billdetail__feetype" FOREIGN KEY ("feetype") REFERENCES "feetype" ("id");

ALTER TABLE "billdetail" ADD CONSTRAINT "fk_billdetail__receipt_id" FOREIGN KEY ("receipt_id") REFERENCES "bill" ("id");
...
ALTER TABLE "biodata" ADD CONSTRAINT "fk_biodata__party" FOREIGN KEY ("party") REFERENCES "party" ("id");
...
CREATE TABLE "instancecrime" (
  "id" INTEGER CONSTRAINT "pk_instancecrime" PRIMARY KEY,
...
CREATE INDEX "idx_instancecrime__parties" ON "instancecrime" ("parties");

ALTER TABLE "instancecrime" ADD CONSTRAINT "fk_instancecrime__crimes" FOREIGN KEY ("crimes") REFERENCES "crime" ("id");

ALTER TABLE "instancecrime" ADD CONSTRAINT "fk_instancecrime__parties" FOREIGN KEY ("parties") REFERENCES "party" ("id");

CREATE TABLE "instancecrime_issues" (
  "instancecrime" INTEGER NOT NULL,
  "issue" INTEGER NOT NULL,
  CONSTRAINT "pk_instancecrime_issues" PRIMARY KEY ("instancecrime", "issue")
);

CREATE INDEX "idx_instancecrime_issues" ON "instancecrime_issues" ("issue");

ALTER TABLE "instancecrime_issues" ADD CONSTRAINT "fk_instancecrime_issues__instancecrime" FOREIGN KEY ("instancecrime") REFERENCES "instancecrime" ("id");
...
ALTER TABLE "issue_defending_parties" ADD CONSTRAINT "fk_issue_defending_parties__party" FOREIGN KEY ("party") REFERENCES "party" ("id");
...
ALTER TABLE "issue_injured_parties" ADD CONSTRAINT "fk_issue_injured_parties__party" FOREIGN KEY ("party") REFERENCES "party" ("id");
...
ALTER TABLE "lawyer_representing" ADD CONSTRAINT "fk_lawyer_representing__party" FOREIGN KEY ("party") REFERENCES "party" ("id");
...
CREATE TABLE "payment" (
  ...
  "pay_trans_cost" DECIMAL(12, 2),
  "receipt_no" VARCHAR(100)
);

CREATE INDEX "idx_payment__bill" ON "payment" ("bill");

ALTER TABLE "payment" ADD CONSTRAINT "fk_payment__bill" FOREIGN KEY ("bill") REFERENCES "bill" ("id");
...
ALTER TABLE "personaleffect" ADD CONSTRAINT "fk_personaleffect__party" FOREIGN KEY ("party") REFERENCES "party" ("id");
...
ALTER TABLE "discipline" ADD CONSTRAINT "fk_discipline__party" FOREIGN KEY ("party") REFERENCES "party" ("id");
...
ALTER TABLE "healthevent" ADD CONSTRAINT "fk_healthevent__party" FOREIGN KEY ("party") REFERENCES "party" ("id");
...
CREATE TABLE "notificationregister" (
  "id" SERIAL CONSTRAINT "pk_notificationregister" PRIMARY KEY,
...
ALTER TABLE "notificationregister" ADD CONSTRAINT "fk_notificationregister__complaint" FOREIGN KEY ("complaint") REFERENCES "complaint" ("id");

ALTER TABLE "notificationregister" ADD CONSTRAINT "fk_notificationregister__complaint_category" FOREIGN KEY ("complaint_category") REFERENCES "complaintcategory" ("id");

ALTER TABLE "notificationregister" ADD CONSTRAINT "fk_notificationregister__court_case" FOREIGN KEY ("court_case") REFERENCES "courtcase" ("id");

ALTER TABLE "notificationregister" ADD CONSTRAINT "fk_notificationregister__document" FOREIGN KEY ("document") REFERENCES "document" ("id");

ALTER TABLE "notificationregister" ADD CONSTRAINT "fk_notificationregister__health_event" FOREIGN KEY ("health_event") REFERENCES "healthevent" ("id");

ALTER TABLE "notificationregister" ADD CONSTRAINT "fk_notificationregister__hearing" FOREIGN KEY ("hearing") REFERENCES "hearing" ("id");

ALTER TABLE "notificationregister" ADD CONSTRAINT "fk_notificationregister__notification_type" FOREIGN KEY ("notification_type") REFERENCES "notificationtype" ("id");

ALTER TABLE "notificationregister" ADD CONSTRAINT "fk_notificationregister__notify_event" FOREIGN KEY ("notify_event") REFERENCES "notifyevent" ("id");

ALTER TABLE "notificationregister" ADD CONSTRAINT "fk_notificationregister__party" FOREIGN KEY ("party") REFERENCES "party" ("id");

CREATE TABLE "notification" (
  "id" SERIAL CONSTRAINT "pk_notification" PRIMARY KEY,
  "contact" TEXT NOT NULL,
...
ALTER TABLE "notification" ADD CONSTRAINT "fk_notification__notification_register" FOREIGN KEY ("notification_register") REFERENCES "notificationregister" ("id");
...
ALTER TABLE "settlement" ADD CONSTRAINT "fk_settlement__settlor" FOREIGN KEY ("settlor") REFERENCES "party" ("id");
...
ALTER TABLE "party_settlees" ADD CONSTRAINT "fk_party_settlees__party" FOREIGN KEY ("party") REFERENCES "party" ("id");
...
ALTER TABLE "commital" ADD CONSTRAINT "fk_commital__parties" FOREIGN KEY ("parties") REFERENCES "party" ("id");
...
CREATE TABLE "csiequipment_investigation_entries" (
  "investigationdiary" INTEGER NOT NULL,
  "csiequipment" INTEGER NOT NULL,
  CONSTRAINT "pk_csiequipment_investigation_entries" PRIMARY KEY ("investigationdiary", "csiequipment")
);

CREATE INDEX "idx_csiequipment_investigation_entries" ON "csiequipment_investigation_entries" ("csiequipment");

ALTER TABLE "csiequipment_investigation_entries" ADD CONSTRAINT "fk_csiequipment_investigation_entries__csiequipment" FOREIGN KEY ("csiequipment") REFERENCES "csiequipment" ("id");

ALTER TABLE "csiequipment_investigation_entries" ADD CONSTRAINT "fk_csiequipment_investigation_entries__investigationdiary" FOREIGN KEY ("investigationdiary") REFERENCES "investigationdiary" ("id");
...
CREATE INDEX "idx_experttestimony__court_case" ON "experttestimony" ("court_case");

CREATE INDEX "idx_experttestimony__experts" ON "experttestimony" ("experts");

CREATE INDEX "idx_experttestimony__requesting_police_officer" ON "experttestimony" ("requesting_police_officer");

ALTER TABLE "experttestimony" ADD CONSTRAINT "fk_experttestimony__court_case" FOREIGN KEY ("court_case") REFERENCES "courtcase" ("id");
...
ALTER TABLE "experttestimony" ADD CONSTRAINT "fk_experttestimony__requesting_police_officer" FOREIGN KEY ("requesting_police_officer") REFERENCES "policeofficer" ("id");
...
ALTER TABLE "investigationdiary_parties" ADD CONSTRAINT "fk_investigationdiary_parties__party" FOREIGN KEY ("party") REFERENCES "party" ("id");

CREATE TABLE "investigationdiary_police_officers" (
  "policeofficer" INTEGER NOT NULL,
  "investigationdiary" INTEGER NOT NULL,
  CONSTRAINT "pk_investigationdiary_police_officers" PRIMARY KEY ("policeofficer", "investigationdiary")
);

CREATE INDEX "idx_investigationdiary_police_officers" ON "investigationdiary_police_officers" ("investigationdiary");

ALTER TABLE "investigationdiary_police_officers" ADD CONSTRAINT "fk_investigationdiary_police_officers__investigationdiary" FOREIGN KEY ("investigationdiary") REFERENCES "investigationdiary" ("id");

ALTER TABLE "investigationdiary_police_officers" ADD CONSTRAINT "fk_investigationdiary_police_officers__policeofficer" FOREIGN KEY ("policeofficer") REFERENCES "policeofficer" ("id");
