...
from sqlalchemy import BigInteger, Boolean, Column, Date, DateTime, ForeignKey, ForeignKeyConstraint, Index, Integer, \
    LargeBinary, Numeric, String, Table, Text, Time
...
class Bill(AuditMixin, Model):
    ...
    __tablename__ = 'bill'
    __table_args__ = (
        ForeignKeyConstraint(['court_account_courts', 'court_account_account__types'],
                             ['courtaccount.courts', 'courtaccount.account__types']),
        Index('idx_bill__court_account_courts_court_account_account__types', 'court_account_courts',
              'court_account_account__types')
    )
    ...
    courtaccount = relationship('Courtaccount',
                                primaryjoin='and_(Bill.court_account_courts == Courtaccount.courts, Bill.court_account_account__types == Courtaccount.account__types)',
                                backref='bills')
...
class Biodata(PersonDocMixin, PersonMedicalMixin, BiometricMixin, ParentageMixin, AuditMixin, Model):
    ...
    economicclass = relationship('Economicclass', primaryjoin='Biodata.economic_class == Economicclass.id',
                                 backref='biodatas')
...
class Casecategory(RefTypeMixin, AuditMixin, Model):
    ...
    parent = relationship('Casecategory', remote_side=[id], primaryjoin='Casecategory.subcategory == Casecategory.id',
                          backref='casecategories')
...
class Commital(ActivityMixin, AuditMixin, Model):
    ...
    parent = relationship('Commital', remote_side=[id], primaryjoin='Commital.commital == Commital.id',
                          backref='commitals')
    commitaltype = relationship('Commitaltype', primaryjoin='Commital.commital_type == Commitaltype.id',
                                backref='commitals')
    ...
    policestation = relationship('Policestation', primaryjoin='Commital.police_station == Policestation.id',
                                 backref='commitals')
    ...
    prisonofficer = relationship('Prisonofficer', primaryjoin='Commital.receiving_officer == Prisonofficer.id',
                                 backref='commitals')
    releasetype = relationship('Releasetype', primaryjoin='Commital.release_type == Releasetype.id',
                               backref='commitals')
    prisonofficer1 = relationship('Prisonofficer', primaryjoin='Commital.releasing_officer == Prisonofficer.id',
                                  backref='commitals_990')
    warranttype = relationship('Warranttype', primaryjoin='Commital.warrant_type == Warranttype.id',
                               backref='commitals')
...
class Complaint(AuditMixin, Model):
    ...
    prosecutorteam = relationship('Prosecutorteam',
                                  primaryjoin='Complaint.evaluating_prosecutor_team == Prosecutorteam.id',
                                  backref='complaints')
    policestation = relationship('Policestation', primaryjoin='Complaint.police_station == Policestation.id',
                                 backref='complaints')
    judicialofficer = relationship('Judicialofficer',
                                   primaryjoin='Complaint.reported_to_judicial_officer == Judicialofficer.id',
                                   backref='complaints')
    policeofficer = relationship('Policeofficer', primaryjoin='Complaint.reportingofficer == Policeofficer.id',
                                 backref='complaints')
...
class Complaintcategory(RefTypeMixin, AuditMixin, Model):
    ...
    parent = relationship('Complaintcategory', remote_side=[id],
                          primaryjoin='Complaintcategory.complaint_category_parent == Complaintcategory.id',
                          backref='complaintcategories')
...
class Country(AuditMixin, Model):
    ...
    lifeexpectancy = Column(Numeric(12, 2))
    gnp = Column(Numeric(12, 2))
    gnpold = Column(Numeric(12, 2))
    localname = Column(String(100))
    governmentform = Column(Text)
    headofstate = Column(Text)
    capital = Column(String(100))
    code2 = Column(String(2))
    surfacearea = Column(Numeric(12, 2))
...
class Courtaccount(AuditMixin, Model):
    ...
    accounttype = relationship('Accounttype', primaryjoin='Courtaccount.account__types == Accounttype.id',
                               backref='courtaccounts')
...
class Courtcase(ActivityMixin, AuditMixin, Model):
    ...
    caselinktype = relationship('Caselinktype', primaryjoin='Courtcase.case_link_type == Caselinktype.id',
                                backref='courtcases')
    prosecutor = relationship('Prosecutor', primaryjoin='Courtcase.filing_prosecutor == Prosecutor.id',
                              backref='courtcases')
    parent = relationship('Courtcase', remote_side=[id], primaryjoin='Courtcase.linked_cases == Courtcase.id',
                          backref='courtcases')
    judicialofficer = relationship('Judicialofficer', primaryjoin='Courtcase.pretrial_registrar == Judicialofficer.id',
                                   backref='courtcases')
    judicialofficer1 = relationship('Judicialofficer', secondary='courtcase_judicialofficer', backref='courtcases_497')
...
# STARTCLASS
class Csiequipment(RefTypeMixin, AuditMixin, Model):
    __versioned__ = {}
    __tablename__ = 'csiequipment'
    
    id = Column(Integer, primary_key=True, autoincrement=True)
    
    investigationdiary = relationship('Investigationdiary', secondary='csiequipment_investigationdiary',
                                      backref='csiequipments')
...
class Diagram(AuditMixin, Model):
    ...
    investigationdiary = relationship('Investigationdiary',
                                      primaryjoin='Diagram.investigation_diary == Investigationdiary.id',
                                      backref='diagrams')
...
class Discipline(RefTypeMixin, AuditMixin, Model):
    ...
    prisonofficer = relationship('Prisonofficer', primaryjoin='Discipline.prison_officer == Prisonofficer.id',
                                 backref='disciplines')
...
class Doctemplate(AuditMixin, Model):
    ...
    templatetype = relationship('Templatetype', primaryjoin='Doctemplate.template_type == Templatetype.id',
                                backref='doctemplates')
...
class Document(DocMixin, AuditMixin, Model):
    ...
    judicialofficer = relationship('Judicialofficer',
                                   primaryjoin='Document.certifying_judicial_officer == Judicialofficer.id',
                                   backref='documents')
    courtcase = relationship('Courtcase', primaryjoin='Document.court_case == Courtcase.id', backref='documents')
    doctemplate = relationship('Doctemplate', primaryjoin='Document.doc_template == Doctemplate.id',
                               backref='documents')
    issue1 = relationship('Issue', primaryjoin='Document.issue == Issue.id', backref='documents')
    judicialofficer1 = relationship('Judicialofficer', primaryjoin='Document.receiving_registrar == Judicialofficer.id',
                                    backref='documents_68')
    judicialofficer2 = relationship('Judicialofficer', primaryjoin='Document.review_registrar == Judicialofficer.id',
                                    backref='documents_603')
...
class Exhibit(DocMixin, AuditMixin, Model):
    ...
    investigationdiary = relationship('Investigationdiary',
                                      primaryjoin='Exhibit.investigation_entry == Investigationdiary.id',
                                      backref='exhibits')
...
class Experttestimony(AuditMixin, Model):
    ...
    courtcase = relationship('Courtcase', primaryjoin='Experttestimony.court_case == Courtcase.id',
                             backref='experttestimonies')
    expert = relationship('Expert', primaryjoin='Experttestimony.experts == Expert.id', backref='experttestimonies')
    investigationdiary = relationship('Investigationdiary',
                                      primaryjoin='Experttestimony.investigation_entries == Investigationdiary.id',
                                      backref='experttestimonies')
    policeofficer = relationship('Policeofficer',
                                 primaryjoin='Experttestimony.requesting_police_officer == Policeofficer.id',
                                 backref='experttestimonies')
...
class Experttype(RefTypeMixin, AuditMixin, Model):
    ...
    parent = relationship('Experttype', remote_side=[id], primaryjoin='Experttype.expert_type == Experttype.id',
                          backref='experttypes')
...
class Feeclass(RefTypeMixin, AuditMixin, Model):
    ...
    parent = relationship('Feeclass', remote_side=[id], primaryjoin='Feeclass.fee_type == Feeclass.id',
                          backref='feeclasses')
...
class Healthevent(ActivityMixin, AuditMixin, Model):
    ...
    healtheventtype = relationship('Healtheventtype', primaryjoin='Healthevent.health_event_type == Healtheventtype.id',
                                   backref='healthevents')
    ...
    prisonofficer = relationship('Prisonofficer',
                                 primaryjoin='Healthevent.reporting_prison_officer == Prisonofficer.id',
                                 backref='healthevents')
...
class Hearing(ActivityMixin, AuditMixin, Model):
    ...
    schedulestatustype = relationship('Schedulestatustype',
                                      primaryjoin='Hearing.schedule_status == Schedulestatustype.id',
                                      backref='hearings')
    ...
    lawfirm1 = relationship('Lawfirm', secondary='hearing_lawfirm_2', backref='hearings_618')
...
class Hearingtype(RefTypeMixin, AuditMixin, Model):
    ...
    parent = relationship('Hearingtype', remote_side=[id], primaryjoin='Hearingtype.hearing_type == Hearingtype.id',
                          backref='hearingtypes')
...
class Interview(AuditMixin, Model):
    ...
    investigationdiary = relationship('Investigationdiary',
                                      primaryjoin='Interview.investigation_entry == Investigationdiary.id',
                                      backref='interviews')
...
class Investigationdiary(ActivityMixin, AuditMixin, Model):
    ...
    complaint1 = relationship('Complaint', primaryjoin='Investigationdiary.complaint == Complaint.id',
                              backref='investigationdiaries')
    warranttype = relationship('Warranttype', primaryjoin='Investigationdiary.warrant_type == Warranttype.id',
                               backref='investigationdiaries')
    party = relationship('Party', secondary='investigationdiary_party', backref='investigationdiaries')
    policeofficer = relationship('Policeofficer', secondary='investigationdiary_policeofficer',
                                 backref='investigationdiaries')
...
class Issue(AuditMixin, Model):
    ...
    judicialofficer = relationship('Judicialofficer', primaryjoin='Issue.judicial_officer == Judicialofficer.id',
                                   backref='issues')
    prosecutor1 = relationship('Prosecutor', primaryjoin='Issue.prosecutor == Prosecutor.id', backref='issues')
    lawyer1 = relationship('Lawyer', secondary='issue_lawyer', backref='issues_57')
    legalreference = relationship('Legalreference', secondary='issue_legalreference', backref='issues')
    legalreference1 = relationship('Legalreference', secondary='issue_legalreference_2', backref='issues_869')
    party = relationship('Party', secondary='issue_party', backref='issues')
    party1 = relationship('Party', secondary='issue_party_2', backref='issues_699')
...
class Judicialofficer(PersonMixin, AuditMixin, Model):
    ...
    courtstation = relationship('Courtstation', primaryjoin='Judicialofficer.court_station == Courtstation.id',
                                backref='judicialofficers')
    judicialrole = relationship('Judicialrole', primaryjoin='Judicialofficer.judicial_role == Judicialrole.id',
                                backref='judicialofficers')
    judicialrank = relationship('Judicialrank', primaryjoin='Judicialofficer.rank == Judicialrank.id',
                                backref='judicialofficers')
...
class Notification(AuditMixin, Model):
    ...
    notificationregister = relationship('Notificationregister',
                                        primaryjoin='Notification.notification_register == Notificationregister.id',
...
class Notificationregister(AuditMixin, Model):
    ...
    complaint1 = relationship('Complaint', primaryjoin='Notificationregister.complaint == Complaint.id',
                              backref='notificationregisters')
    complaintcategory = relationship('Complaintcategory',
                                     primaryjoin='Notificationregister.complaint_category == Complaintcategory.id',
                                     backref='notificationregisters')
    courtcase = relationship('Courtcase', primaryjoin='Notificationregister.court_case == Courtcase.id',
                             backref='notificationregisters')
    document1 = relationship('Document', primaryjoin='Notificationregister.document == Document.id',
                             backref='notificationregisters')
    healthevent = relationship('Healthevent', primaryjoin='Notificationregister.health_event == Healthevent.id',
                               backref='notificationregisters')
    hearing1 = relationship('Hearing', primaryjoin='Notificationregister.hearing == Hearing.id',
                            backref='notificationregisters')
    notificationtype = relationship('Notificationtype',
                                    primaryjoin='Notificationregister.notification_type == Notificationtype.id',
                                    backref='notificationregisters')
    notifyevent = relationship('Notifyevent', primaryjoin='Notificationregister.notify_event == Notifyevent.id',
                               backref='notificationregisters')
    party1 = relationship('Party', primaryjoin='Notificationregister.party == Party.id',
                          backref='notificationregisters')
    sysuserextra = relationship('Sysuserextra', primaryjoin='Notificationregister.user_to_notify == Sysuserextra.id',
                                backref='notificationregisters')
...
class Party(PersonMixin, ContactMixin, AuditMixin, Model):
    ...
    complaintrole = relationship('Complaintrole', primaryjoin='Party.complaint_role == Complaintrole.id',
                                 backref='parties')
...
class Personaleffect(AuditMixin, Model):
    ...
    personaleffectscategory = relationship('Personaleffectscategory',
                                           primaryjoin='Personaleffect.personal_effects_category == Personaleffectscategory.id',
                                           backref='personaleffects')
...
class Policeofficer(PersonMixin, AuditMixin, Model):
    ...
    policeofficerrank = relationship('Policeofficerrank',
                                     primaryjoin='Policeofficer.police_rank == Policeofficerrank.id',
                                     backref='policeofficers')
...
class Policestation(PlaceMixin, RefTypeMixin, AuditMixin, Model):
    ...
    policeofficer = relationship('Policeofficer', primaryjoin='Policestation.officer_commanding == Policeofficer.id',
                                 backref='policestations')
    policestationrank = relationship('Policestationrank',
                                     primaryjoin='Policestation.police_station_rank == Policestationrank.id',
                                     backref='policestations')
...
class Prisonofficer(PersonMixin, AuditMixin, Model):
    ...
    prisonofficerrank = relationship('Prisonofficerrank',
                                     primaryjoin='Prisonofficer.prison_officer_rank == Prisonofficerrank.id',
                                     backref='prisonofficers')
...
class Prosecutor(PersonMixin, ContactMixin, AuditMixin, Model):
    ...
    prosecutorteam = relationship('Prosecutorteam', primaryjoin='Prosecutor.prosecutor_team == Prosecutorteam.id',
                                  backref='prosecutors')
...
class Seizure(AuditMixin, Model):
    ...
    investigationdiary = relationship('Investigationdiary',
                                      primaryjoin='Seizure.investigation_diary == Investigationdiary.id',
                                      backref='seizures')
...
# STARTCLASS
class Sysuserextra(ContactMixin, AuditMixin, Model):
    __versioned__ = {}
    ...
    syswkflowgrp1 = relationship('Syswkflowgrp', primaryjoin='Sysuserextra.syswkflowgrp == Syswkflowgrp.id',
                                 backref='sysuserextras')
...
class Sysviewfld(AuditMixin, Model):
    ...
    sysviewlist = relationship('Sysviewlist', primaryjoin='Sysviewfld.sys__view == Sysviewlist.id',
                               backref='sysviewflds')
...
class Syswkflow(AuditMixin, Model):
    ...
    syswkflowgrp1 = relationship('Syswkflowgrp', primaryjoin='Syswkflow.syswkflowgrp == Syswkflowgrp.id',
                                 backref='syswkflows')
...
class Syswkflowviewseq(AuditMixin, Model):
    ...
    sysviewlist = relationship('Sysviewlist', primaryjoin='Syswkflowviewseq.sys__view__lists == Sysviewlist.id',
                               backref='syswkflowviewseqs')
    syswkflow = relationship('Syswkflow', primaryjoin='Syswkflowviewseq.sys_wkflows == Syswkflow.id',
                             backref='syswkflowviewseqs')
...
class Templatetype(RefTypeMixin, AuditMixin, Model):
    ...
    parent = relationship('Templatetype', remote_side=[id], primaryjoin='Templatetype.template_type == Templatetype.id',
                          backref='templatetypes')
...
class Vehicle(AuditMixin, Model):
    ...
    policestation = relationship('Policestation', primaryjoin='Vehicle.police_station == Policestation.id',
                                 backref='vehicles')
